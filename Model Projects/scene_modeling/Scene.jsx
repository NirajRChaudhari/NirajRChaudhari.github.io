...
Command: npx gltfjsx@6.2.3 public/models/scene.gltf -k
*/
...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group name="LavaLamp" position={[-1.328, 2.089, -1.986]} scale={1.145}>
      ...
      <mesh name="Astronaut" geometry={nodes.Astronaut.geometry} material={materials.Pink} position={[-1.031, 2.124, -2.006]} rotation={[0, 1.324, 0]}>
        <mesh name="Cube002" geometry={nodes.Cube002.geometry} material={materials['6']} scale={0.121} />
        <mesh name="Cube003" geometry={nodes.Cube003.geometry} material={materials['10.001']} scale={0.121} />
        <mesh name="Cube004" geometry={nodes.Cube004.geometry} material={materials['7']} scale={0.121} />
        <mesh name="Sphere007" geometry={nodes.Sphere007.geometry} material={materials.Pink} />
        <mesh name="Sphere008" geometry={nodes.Sphere008.geometry} material={materials['13']} />
      </mesh>
      <group name="AndroidToy" position={[-0.326, 2.284, -1.915]} rotation={[0, -0.037, 0]} scale={0.011}>
        <mesh name="Sphere001" geometry={nodes.Sphere001.geometry} material={materials['android eye']} />
        <mesh name="Sphere001_1" geometry={nodes.Sphere001_1.geometry} material={materials.android} />
      </group>
      <mesh name="Plane001" geometry={nodes.Plane001.geometry} material={materials.White} />
      <mesh name="Plane001_1" geometry={nodes.Plane001_1.geometry} material={materials.Glass} />
      <mesh name="Plane001_2" geometry={nodes.Plane001_2.geometry} material={materials.Floor} />
      <mesh name="Plane001_3" geometry={nodes.Plane001_3.geometry} material={materials.Wall} />
    </group>
  )
}
